    ...
    <div className='rounded-div mt-8 pt-8 text-primary'>
      <div className='flex flex-col md:w-[70%] m-auto'>
        <div className='flex flex-row justify-between items-center'>
          <div className='w-[50%]'>
            <div>
              <p className='text-center'>James Collyer</p>
            </div>
            <div className='flex py-4 justify-between text-accent w-40 m-auto'>
              <FaGithub
                onClick={() => (
                  window.open("https://github.com/JamesCollyer", '_blank', 'noopener,noreferrer')
                )}
                size={30} className='cursor-pointer hover:scale-105 duration-200'
              />
              <FaLinkedin
                onClick={() => (
                  window.open("https://www.linkedin.com/in/james-collyer-24a351236/", '_blank', 'noopener,noreferrer')
                )}
                size={30} className='cursor-pointer hover:scale-105 duration-200'
              />
              <MdEmail
